...
public class MainActivity extends ListActivity {
    private static final String PREFS_FILE = "com.tadevelopers.golfscorecard.preferences";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSharedPreference = getSharedPreferences(PREFS_FILE, Context.MODE_PRIVATE);
        mEditor = mSharedPreference.edit();
        int strokes = 0;
        for (int i =0;i<mHoles.length;i++){
            strokes = mSharedPreference.getInt(KEY_STROKECOUNT + i,0);
